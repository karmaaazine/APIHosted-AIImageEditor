...
import { Upload, Download, Loader, AlertCircle, ImageIcon, Brush, Eraser, RotateCcw, ArrowLeft, Eye } from 'lucide-react'
...
export default function InpaintPage() {
  ...
  const promptExamples = [
    'black sunglasses with dark frames',
    'stylish aviator glasses with metal frames',
    'clear reading glasses with thin frames',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900">AI Inpainting</h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100vh-120px)]">
          ...
          <div className="space-y-4 overflow-y-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm p-4">
              <h3 className="font-semibold text-gray-900 mb-3">Brush Tools</h3>
          ...
          {/* Canvas */}
          <div className="bg-white rounded-xl shadow-sm p-4">
            <h3 className="font-semibold text-gray-900 mb-3">Paint Mask</h3>
            {originalImageUrl ? (
